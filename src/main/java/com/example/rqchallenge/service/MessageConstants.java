...
public class MessageConstants {
    ...
    public static final String NAME_FIELD_MISSING_MESSAGE = "Name field is missing in create employee request";
    public static final String SALARY_FIELD_MISSING_ERROR_MESSAGE = "Salary field is missing in create employee request";
    public static final String INVALID_SALARY_FIELD_VALIDATION_MESSAGE = "Invalid salary field is passed in create employee request";
    public static final String INVALID_NAME_FIELD_VALIDATION_MESSAGE = "Invalid name field is passed in create employee request";
    public static final String AGE_FIELD_MISSING_MESSAGE = "Age field is missing in create employee request";
    public static final String INVALID_AGE_FIELD_VALIDATION_MESSAGE = "Invalid age field is passed in create employee request";
